...
int main()
{
    ...
    for( ; contador <= 9 ; ) //Se inicia un ciclo for que se ejecutará mientras la variable contador que funciona como contador sea menor o igual a 9 (numero de ternas)
    {
