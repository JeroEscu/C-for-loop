...
{   
    for( ; numero == 0 ; ) //Se ejecuta el ciclo for que verifica si el numero es igual a 0
    {
...
{   
    ...
    int numero=0, numeroMayor=0, numeroMenor=__INT_MAX__, negativos=0, positivos=0, mayores150=0;//se declaran las variables numero, numeroMayor, numeroMenor, negativos, positivos, sumaPositivos y mayores150 de tipo entero de tipo entero para clasificar los numeros ingresados
