...
int main()
{
    int espaciosIniciales = 0, espaciosMedios = 17; //Se declaran las variables espaciosIniciales y espaciosMedios de tipo entero que almacenan la cantidad de espacios que se van a imprimir
