...
int main()
{
    int cantidadDeLetras = 13, cantidadDeEspacios = 33; //Se declaran las variables de tipo entero cantidadDeLetras y cantidadDeEspacios para almacenar la cantidad de letras y espacios que se imprimirán en cada fila respectivamente
